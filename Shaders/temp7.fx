...
//  bool
    ...
    [loop]
    for(0;/*!foundU&&!foundD&&!foundL&&!foundR*/j<=(1.0/BUFFER_WIDTH)*CyCles;i+=(1.0/BUFFER_HEIGHT)*DiamondSizeV,j+=(1.0/BUFFER_WIDTH)*DiamondSizeV)
...
//		    if(j==(1.0/BUFFER_WIDTH)*CyCles)
//		    {
//				texcoord2.g = texcoord.y+i;//upedge in r;
//			}
        }
    	if(!foundL)
        {
...
//		    if(j==(1.0/BUFFER_WIDTH)*CyCles)
//		    {
//				texcoord2.b = texcoord.x-i;//upedge in r;
//			}
        }
    	if(!foundR)
        {
...
//		    if(j==(1.0/BUFFER_WIDTH)*CyCles)
//		    {
//				texcoord2.a = texcoord.x+i;//upedge in r;
//			}
        }
//        i+=(1.0/BUFFER_HEIGHT),j+=(1.0/BUFFER_WIDTH);
    }
